...
test_length = Length.new(1, :mi)
second_length = Length.new(2, :km)
puts second_length.as_miles.value
puts test_length.value < second_length.value
...
# The Array #sort method uses the <=> opertor which has not been defined for the Length class. In order to sort we need to defnine it in the classs
