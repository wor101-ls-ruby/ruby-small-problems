class Card
  ...
  def <=>(other_card)
    if rank.class == Integer && other_card.rank.class == Integer
      rank <=> other_card.rank
    elsif rank.class == Integer && other_card.rank.class == String
      -1
    elsif rank.class == String && other_card.rank.class == Integer
      1
    else
