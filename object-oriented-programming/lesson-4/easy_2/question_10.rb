=begin What are the benefits of using Object Oriented Programming in Ruby? Think of as many as you can.

  - allows us to compartmentalize problems and break them down into manageable pieces
  - allows us to make changes to a program without potential cascading issues
  - allows us to create and interact with unique objects designed for the problem
  - allows us to encapsulate variables and methods to avoid accidentally overiding them
