# The Enumerable#each_cons method iterates over the members of a collection taking each sequence of n consecutive elements at a time and passing them to the associated block for processing. 
...
def each_cons(array)
  array.each_with_index do |value, index|
    yield(value, array[index + 1]) unless index + 1 >= array.size 
  end
  nil
end
