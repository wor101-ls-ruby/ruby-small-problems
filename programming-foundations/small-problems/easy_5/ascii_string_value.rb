...
# **Algorithm**
# 1. Create a 'characters' array that equals 'string'.chars
...
def ascii_value(string)
  ...
  characters.each do |char| # could use instance method .each_char on the string instead of coverting to array
    sum += char.ord
  end
